	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
							<c:forEach items="${listGrade}" var="grade">
								<li><a class="dropdown-item bg-dark text-white" href="#">${grade.getNameGrade()}</a>
								</li>
							</c:forEach>
							<li>
								<hr class="dropdown-divider" />
				...
				<div class="mx-2">
					<a class="btn btn-outline-secondary"
						href="/multichoice_project/login" role="button">Log
						in</a> <a class="btn btn-outline-secondary"
						href="/multichoice_project/register" role="button">Sign
						in</a>
				</div>
				<!-- Button login signin -->
					...
					<div class="btn-group">
						...
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item text-white"
								href="/multichoice_project/customer_info">More
								Infomation</a> <a class="dropdown-item text-white" href="#">History</a>
							<a class="dropdown-item text-white" href="#">Rank</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item text-white"
								href="/multichoice_project/login">Log out</a>
						</div>
					</div>
				</div>
				<!-- Button logout -->
