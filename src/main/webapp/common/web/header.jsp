...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    <a class="navbar-brand" href="/multichoice_project/trang-chu"
      >Multiple Choice Web App</a
    >
    <button
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto d-flex">
        <li class="nav-item active">
          <a class="nav-link" href="/multichoice_project/trang-chu"
      ...
      <div class="mx-2">
        <a
          class="btn btn-outline-secondary"
          href="/multichoice_project/login"
          role="button"
          >Log in</a
        >
        <a
          class="btn btn-outline-secondary"
          href="/multichoice_project/register"
          role="button"
          >Sign in</a
        >
      </div>
        ...
        <div class="btn-group">
          ...
          <div class="dropdown-menu bg-dark">
            <a
              ...
              href="/multichoice_project/customer_info"
              >More Infomation</a
            >
            <a class="dropdown-item text-white" href="#">History</a>
